                        ...
                        <div class="col-lg-12">
                            <div class="qodef-media-uploader">
                                <div<?php if (!$has_value) { ?> style="display: none"<?php } ?>
                                    ...
                                    <img src="<?php if ($has_value) { echo esc_url(succulents_qodef_option_get_uploaded_file_icon($value)); } ?>" alt="<?php esc_attr_e('Thumbnail Image','succulents'); ?>"
                                ...
                                <a class="qodef-media-upload-btn btn btn-sm btn-primary"
                                   ...
                                   data-frame-title="<?php esc_attr_e('Select File', 'succulents'); ?>"
